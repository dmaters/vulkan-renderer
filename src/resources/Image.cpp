...
void Image::LayoutTransition(
	...
	if (oldLayout == vk::ImageLayout::eColorAttachmentOptimal) {
		layoutBarrier.srcStageMask =
			vk::PipelineStageFlagBits2::eColorAttachmentOutput;
		layoutBarrier.srcAccessMask =
			vk::AccessFlagBits2::eColorAttachmentWrite;
		layoutBarrier.dstStageMask = vk::PipelineStageFlagBits2::eBottomOfPipe;
		layoutBarrier.dstAccessMask = vk::AccessFlagBits2::eNone;
	} else if (newLayout == vk::ImageLayout::eTransferDstOptimal ||
	           oldLayout == vk::ImageLayout::eTransferDstOptimal) {
		layoutBarrier.srcStageMask = vk::PipelineStageFlagBits2::eTopOfPipe;
		layoutBarrier.srcAccessMask = vk::AccessFlagBits2::eNone;
		layoutBarrier.dstStageMask = vk::PipelineStageFlagBits2::eTransfer;
		layoutBarrier.dstAccessMask = vk::AccessFlagBits2::eTransferWrite;
	} else {
		layoutBarrier.srcStageMask = vk::PipelineStageFlagBits2::eTopOfPipe;
		layoutBarrier.srcAccessMask = vk::AccessFlagBits2::eNone;
