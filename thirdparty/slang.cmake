...
if (WIN32)
  ...
  set_target_properties(slang PROPERTIES
      INTERFACE_DLL_PATH
      "${slang_zip_SOURCE_DIR}/bin/slang-compiler.dll;${slang_zip_SOURCE_DIR}/bin/slang-glslang.dll"
    )
elseif (UNIX)
  target_link_libraries(slang INTERFACE "${slang_zip_SOURCE_DIR}/lib/libslang-compiler.so.0.${SLANG_VERSION}" "${slang_zip_SOURCE_DIR}/lib/libslang-glslang-${SLANG_VERSION}.so")
endif ()
